      ...
      <v-row>
        <v-col cols="12" sm="12" md="12" lg="12">
          ...
          <v-card width="100%" height="100%" elevation="-20">
            ...
            <v-divider></v-divider>
            <v-data-table locale="es" :headers="headers" :items="getEstudiantes" :items-per-page="10" :page.sync="page" @page-count="pageCount = $event" class="elevation-1" :search="busqueda" hide-default-footer>
              <!--
          ...
          <v-dialog persistent v-model="eliminar" width="750px">
            <EstudianteDelete v-bind:currentStudent="currentStudent" :eliminar.sync="eliminar" />
          </v-dialog>
        </v-col>
      </v-row>
    </v-container>
