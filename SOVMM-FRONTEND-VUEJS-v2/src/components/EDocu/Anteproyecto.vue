<template>
  <v-card flat style="margin-bottom: -0.5rem">
    <v-form>
      <v-row>
        <v-col cols="12">
          <a @click="styleButton" style="color: inherit; text-decoration: none;" href="https://sovmm-bucket-01.s3.us-east-2.amazonaws.com/FORMATO-ANTEPROYECTO+DE+RESIDENCIAS+PROFESIONALES.pdf" target="_blank">
          ...
          <form action="https://sovmm-bucket-01.s3.us-east-2.amazonaws.com/FORMATO-ANTEPROYECTO+DE+RESIDENCIAS+PROFESIONALES.pdf" method="get"></form>
        </v-col>
        <v-col cols="12">
          <v-card-subtitle>
      ...
      <v-row>
        <v-col cols="12" class="d-flex align-center justify-center">
          <v-card
            flat
            v-for="document in selectedProyecto.anteProy"
            :key="document"
            style="width: 100%;
                "
          >
