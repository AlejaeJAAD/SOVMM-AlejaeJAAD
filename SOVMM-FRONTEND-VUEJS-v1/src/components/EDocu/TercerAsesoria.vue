    ...
    <v-form>
      <v-row>
        <v-col cols="12">
          <a @click="styleButton" style="color: inherit; text-decoration: none;"
             href="https://sovmm-03.s3.us-east-2.amazonaws.com/FORMATO-REGISTRO+DE+ASESORIA.pdf"
             target="_blank">
            <v-btn
              large
              dark
          ...
          <form action="https://sovmm-03.s3.us-east-2.amazonaws.com/FORMATO-REGISTRO+DE+ASESORIA.pdf"
                method="get">
          </form>
        </v-col>
        <v-col cols="12">
      ...
      <v-row>
        <v-col cols="12">
          <v-card flat
                  align="center"
                  v-for="document in this.info.tercerAsesoria" :key="document">
            <pdf :src="document"
                 :page="currentPage"
