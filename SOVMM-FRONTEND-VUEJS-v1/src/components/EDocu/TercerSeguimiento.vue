  ...
  <v-card flat style="margin-bottom: -0.5rem">
    <v-form>
      ...
      <v-card flat style="background-color: #333333"
        ...
        CARGAR TERCER SEGUIMIENTO DE RESIDENCIAS PROFESIONALES CORRESPONDIENTE PARA SU ACTUALIZACION
      </v-card>
      <v-row>
        <v-col cols="12">
          <v-card flat
                  align="center"
                  v-for="document in this.info.tercerSeguimientoEv" :key="document">
            <pdf :src="document"
                 :page="currentPage"
...
export default {
  ...
  methods: {
    ...
    postDocument() {
      console.log(this.tercerSeguimientoEv, 'ih');
      console.log(this.proy.tercerSeguimientoEv, '49494');
      /*
      const data = {
        document: '',
      };
